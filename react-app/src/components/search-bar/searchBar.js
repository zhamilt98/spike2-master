        ...
        if ( isLoaded ) {
            return (
                <div className="search_container">
                    <svg xmlns="http://www.w3.org/2000/svg" width="15vw" height="15vh" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16" style={{ position: 'absolute', left: '45vw', top: '-20vh', marginBottom: '25px'}}>
